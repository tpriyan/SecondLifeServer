...
namespace TextureChanger.Logic
{
    public class GridOperations
    {
        ...
        public void LoadData(System.Web.UI.WebControls.GridView gridView)
        {
            ...
            using (System.Data.SQLite.SQLiteConnection con = new System.Data.SQLite.SQLiteConnection("data source=" + HttpContext.Current.Server.MapPath("~/App_Data/UsersDataDB.db")))
            {
    ...
    public class CRUDOperations
    {
        public BaseEnums.URLStatus createOrUpdateURL(string objectGuid, string URL, string OwnerName, string type, string ObjectName)
        {
            ...
            string sqlQueryInsert = "insert into InworldObjects(ObjectGUID, URL, Name, Type, Owner) values ('{0}', '{1}', '{2}', '{3}', '{4}')";
            string sqlQueryUpdate = "update InworldObjects set URL = '{0}', Name='{1}', Type = '{2}', Owner = '{3}'  where ObjectGUID = '{4}'";
